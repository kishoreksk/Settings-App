...
class SettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setting" do
    assert_difference("Setting.count") do
      post settings_url, params: { setting: { name: @setting.name, settings: @setting.settings } }
    end
  ...
  test "should update setting" do
    patch setting_url(@setting), params: { setting: { name: @setting.name, settings: @setting.settings } }
